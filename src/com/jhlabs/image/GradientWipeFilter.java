...
/**
 * A filter which can be used to produce wipes by transferring the luma of a mask com.jhlabs.image into the alpha channel of the source.
 */
public class GradientWipeFilter extends AbstractBufferedImageOp {
	...
	/**
	 * Set the density of the com.jhlabs.image in the range 0..1.

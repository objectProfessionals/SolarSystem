...
/**
 * A filter which uses the alpha channel of a "mask" com.jhlabs.image to interpolate between a source and destination com.jhlabs.image.
 */
public class ApplyMaskFilter extends AbstractBufferedImageOp {
    ...
    /**
     * Construct an ApplyMaskFIlter.
     * @param maskImage the mask com.jhlabs.image
    ...
    /**
     * Get the mask com.jhlabs.image.
     * @return the mask com.jhlabs.image
     * @see #setMaskImage
     */

...
/**
 * A filter which can be used to produce wipes by transferring the luma of a Destination com.jhlabs.image into the alpha channel of the source.
 */
public class ChromaKeyFilter extends AbstractBufferedImageOp {
	...
	/**
	 * Set the tolerance of the com.jhlabs.image in the range 0..1.

...
public abstract class ImageUtils {
	...
	/**
	 * Convert an Image into a TYPE_INT_ARGB BufferedImage. If the com.jhlabs.image is already of this type, the original com.jhlabs.image is returned unchanged.
     * @param image the com.jhlabs.image to convert
     * @return the converted com.jhlabs.image
	 */
	...
	/**
	 * Returns a *copy* of a subimage of com.jhlabs.image. This avoids the performance problems associated with BufferedImage.getSubimage.
     * @param image the com.jhlabs.image
     ...
     * @param image the com.jhlabs.image to clone
     * @return the cloned com.jhlabs.image
	 */
	...
	/**
	 * Paint a check pattern, used for a background to indicate com.jhlabs.image transparency.
    ...
    /**
     * Calculates the bounds of the non-transparent parts of the given com.jhlabs.image.
     * @param p the com.jhlabs.image

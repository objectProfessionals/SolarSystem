...
/**
 * A filter which rotates an com.jhlabs.image. These days this is easier done with Java2D, but this filter remains.
 */
public class RotateFilter extends TransformFilter {
     ...
     * Construct a RotateFilter.
     * @param angle the angle to rotate
     * @param resize true if the output com.jhlabs.image should be resized
     */

 ...
 * You need to supply two warp grids, one for the source com.jhlabs.image and
 * one for the destination com.jhlabs.image. The com.jhlabs.image will be warped so that
...
public class WarpFilter extends WholeImageFilter {
	...
	/**
	 * For morphing, sets the com.jhlabs.image we're morphing to. If not, set then we're just warping.
	 */

...
/**
 * A filter which simulates the appearance of looking through glass. A separate grayscale displacement com.jhlabs.image is provided and
 * pixels in the source com.jhlabs.image are displaced according to the gradient of the displacement map.
 */
public class DisplaceFilter extends TransformFilter {
	 ...
	 * @param displacementMap an com.jhlabs.image representing the displacment at each point
	 ...
	 * @return an com.jhlabs.image representing the displacment at each point

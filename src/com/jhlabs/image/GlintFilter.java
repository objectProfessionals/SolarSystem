...
/**
 * A filter which renders "glints" on bright parts of the com.jhlabs.image.
 */
public class GlintFilter extends AbstractBufferedImageOp {
	...
	/**
     * Set whether to render the stars and the com.jhlabs.image or only the stars.
	...
	/**
     * Get whether to render the stars and the com.jhlabs.image or only the stars.

...
/**
 * An experimental filter which can be used for keying against a clean shot. Given a source com.jhlabs.image, a clean com.jhlabs.image and a destination com.jhlabs.image,
...
public class KeyFilter extends AbstractBufferedImageOp {
	...
	/**
	 * Set the hue tolerance of the com.jhlabs.image in the range 0..1.
	...
	/**
	 * Set the saturation tolerance of the com.jhlabs.image in the range 0..1.
	...
	/**
	 * Set the brightness tolerance of the com.jhlabs.image in the range 0..1.
    ...
    /**
     * Set the destination com.jhlabs.image.
     * @param destination the destination com.jhlabs.image
     * @see #getDestination
     */
    ...
    /**
     * Get the destination com.jhlabs.image.
     * @return the destination com.jhlabs.image
     * @see #setDestination
     */
    ...
    /**
     * Get the clean com.jhlabs.image.
     * @param cleanImage the clean com.jhlabs.image
     * @see #getCleanImage
     */
    ...
    /**
     * Get the clean com.jhlabs.image.
     * @return the clean com.jhlabs.image
     * @see #setCleanImage
     */

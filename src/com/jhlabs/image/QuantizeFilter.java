...
/**
 * A filter which quantizes an com.jhlabs.image to a set number of colors - useful for producing
 ...
 * methods such as median cut. Note: at present, the filter produces an com.jhlabs.image which
...
public class QuantizeFilter extends WholeImageFilter {
	...
	/**
	 * Set whether to use dithering or not. If not, the com.jhlabs.image is posterized.

...
/**
 * A filter which performs a tritone conversion on an com.jhlabs.image. Given three colors for shadows, midtones and highlights,
 * it converts the com.jhlabs.image to grayscale and then applies a color mapping based on the colors.
 */

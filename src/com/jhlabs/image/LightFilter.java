...
public class LightFilter extends WholeImageFilter {
    ...
    /**
     * Take the output colors from the input com.jhlabs.image.
     */
    ...
    /**
     * Use the input com.jhlabs.image brightness as the bump map.
     */
	public final static int BUMPS_FROM_IMAGE = 0;

    /**
     * Use the input com.jhlabs.image alpha as the bump map.
     */
	public final static int BUMPS_FROM_IMAGE_ALPHA = 1;

    /**
     * Use a separate com.jhlabs.image alpha channel as the bump map.
     */
...
//					rv = (float)Math.pow(rDotV, material.highlight);
	...
	public static class Light implements Cloneable {
        ...
        /**
         * Set the centre of the light in the X direction as a proportion of the com.jhlabs.image size.
        ...
        /**
         * Get the centre of the light in the X direction as a proportion of the com.jhlabs.image size.
         * @return the center
         * @see #setCentreX
         */
        ...
        /**
         * Set the centre of the light in the Y direction as a proportion of the com.jhlabs.image size.
        ...
        /**
         * Get the centre of the light in the Y direction as a proportion of the com.jhlabs.image size.
         * @return the center
         * @see #setCentreY
         */
         ...
         * @param width the output com.jhlabs.image width
         * @param height the output com.jhlabs.image height
         */
